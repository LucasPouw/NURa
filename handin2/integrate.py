...
if __name__ == '__main__':
    ...
    for N in [10, 100, 1000, 10000]:
        ...
        print(f'Trapezoid for N = {N} gives {trapz}. So the error is {true_value - trapz}.')
        print(f'Simpson for N = {N} gives {simp}. So the error is {true_value - simp}.')

    for m in [2, 4, 6]:
        romb = romberg(func, 0, 10, m)[0]
        print(f'Romberg for m = {m} gives {romb}. So the error is {true_value - romb}.')
